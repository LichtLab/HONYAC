...
import com.nature.code.odica.BeepManager;
...
final class DecodeHandler extends Handler {
  ...
  private OcrRecognizeAsyncTask ocrRecognizeAsyncTask = null;
  ...
  private void ocrDecode(byte[] data, int width, int height) {
    ...
    if(ocrRecognizeAsyncTask != null) {
    	ocrRecognizeAsyncTask.cancel(true);
	}
    ocrRecognizeAsyncTask = new OcrRecognizeAsyncTask(activity, baseApi, data, width, height);
